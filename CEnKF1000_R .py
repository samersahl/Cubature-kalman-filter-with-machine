...
print(plot_model(model_conv1D_2, to_file='model_plot2.png', show_shapes=True, show_layer_names=True))
model_fit = model_conv1D_2.fit(train_data_reshaped, correct_data_reshaped,
                               ...
                               epochs=900, verbose=2, batch_size=8, validation_batch_size=2)
...
io.savemat('x3.mat', {"data1":  prediction_whole_model})
fig.show()
