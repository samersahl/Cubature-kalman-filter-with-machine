...
def build_multi_conv1D_model():
    ...
    cnn2 = keras.layers.Conv1D(40, 5, padding="same", activation="linear", strides=1, kernel_regularizer=keras.regularizers.L2(.0001))(conc)
    add = keras.layers.Add()([cnn2, input])
